...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('retail_package_options', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('retail_pakage_option_name',50)->nullable();
    ...
    {
        Schema::dropIfExists('retail_package_options');
    }
};
